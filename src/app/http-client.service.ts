...
export class HttpClientService {
  ...
  public get(endpoint:String): Promise<any[]> {
    return this.http.get(this.host + endpoint, this.httpOptions)
    .toPromise()
    .then((res) => {
  ...
  public postSignUp(user:User): Promise<any[]>{
    return this.http.post<User>(this.host + '/signup', this.httpOptions)
    .toPromise()
    .then((res) => {
  ...
  public postLogin(loginInfo:LoginInfo): Promise<any[]>{
    return this.http.post<User>(this.host + '/login', this.httpOptions)
    .toPromise()
    .then((res) => {
